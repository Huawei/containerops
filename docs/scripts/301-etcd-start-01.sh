...
../bin/etcd/etcd \
  ...
  --initial-advertise-peer-urls=https://10.138.232.252:2380 \
  --listen-peer-urls=https://10.138.232.252:2380 \
  --listen-client-urls=https://10.138.232.252:2379 \
  --advertise-client-urls=https://10.138.232.252:2379 \
  ...
  --data-dir=/var/lib/etcd/etcd-dec0ac166ff2dbf8eab068ca47decaa4-etcd-01 \
  --enable-v2
