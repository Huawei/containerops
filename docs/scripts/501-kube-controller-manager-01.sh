...
--client-certificate="../ca/kubernetes-rbac-kube-controller-manager-01-ca.pem" \
--client-key="../ca/kubernetes-rbac-kube-controller-manager-01-ca-key.pem" \
--server="${KUBE_APISERVER_PROXY}" \
--embed-certs=true \
--kubeconfig=controller-manager01.conf
...
# set default context
../bin/kubernetes/client/kubectl config use-context system:kube-controller-manager@kubernetes --kubeconfig=controller-manager01.conf
