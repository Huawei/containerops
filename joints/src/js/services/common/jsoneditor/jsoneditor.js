...
define(['services/module','services/common/jsoneditor/jsoneditor.menu'], function(commonServiceModule) {
    commonServiceModule.factory("jsonEditor", ["jsonEditorMenu", function(jsonEditorMenu) {
        ...
        function parse(str) {
            var res;
            try { res = JSON.parse(str); } catch (e) { res = null;
        ...
        function stringify(obj) {
            var res;
            try { res = JSON.stringify(obj); } catch (e) { res = 'null';
        ...
        function addMenu(item, opt) {
            if (item.children('.menuer').length == 0) {
                ...
                menuer.bind('click', function() {
                    ...
                    jsonEditorMenu.ContextMenu($(this), items, opt);
                });
                item.prepend(menuer);
            }
        }
