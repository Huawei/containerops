...
//ComponentLog is customized container(docker or rkt) for executing DevOps tasks.
...
//TableName is return the table name of Component in MySQL database.
func (c *ComponentLog) TableName() string {
	return "component_log"
}

func (c *ComponentLog) GetComponentLog() *gorm.DB {
	return db.Model(&ComponentLog{})
}
