...
type Component struct {
	...
	ImageTag     string     `json:"image_tag" gorm:"null;type:varchar(255);index:idx_component_image_tag"`                    //For now only Docker Registry Specification has tag concept, the component of Docker type is refer in particular to tag of docker image.
	...
	Environments string     `json:"environment" gorm:"null;type:text"`                                                        //Environments parameters.
